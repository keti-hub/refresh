...
function course_scripts() {
	wp_enqueue_style( 'course-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'course-style', 'rtl', 'replace' );

	wp_enqueue_script( 'course-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
